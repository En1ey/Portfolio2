...
export default function Home() {
    const projectData = [
        ...
        { type: "Brochure Design", title: "Brochure of Chile", description: "This brochure highlights the country of Chile, covering its climate, traditions, culture, and cuisine. It presents key information in a way that's both informative and engaging. The fonts, text size, and layout are carefully designed to ensure that the content is easy to read and visually appealing for viewers.", imgSrc: "/img/chile.png" },
                ...
                <div className="container">
                    <div className={styles.profileContent}>
                        ...
                        <div className={styles.profileText}>
                            ...
                            <p>Hello! I'm a creative professional specializing in web design, product mockups, and video editing. With a passion for creating visually stunning and functional digital experiences, I bring ideas to life through innovative design solutions. My work combines technical expertise with artistic vision to deliver exceptional results for every project.</p>
                        </div>
                    </div>
                </div>
            </section>
